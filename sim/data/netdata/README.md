...
**Source**: Tsinghua FIB Lab, `https://github.com/tsinghua-fib-lab/NetData`
(Git-LFS). The energy-model calibration in this paper uses
`Performance_5G_Weekday.csv` (~79 MB, ~1.0 M records over ~20.9 k 5G cells).
Place it at `sim/data/netdata/Performance_5G_Weekday.csv`. The file is not
redistributed here; clone it from the upstream repository (LFS-tracked).
